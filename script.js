...
console.log('%c👋 Hey there! Thanks for checking out my portfolio!', 'font-size: 20px; color: #14b8a6; font-weight: bold;');
console.log('%c🚀 Looking for a developer? Let\'s connect!', 'font-size: 14px; color: #06b6d4;');